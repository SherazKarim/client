      ...
      <div className="container">
        ...
        <div className="sections">
          <div className="left">
            ...
            <input type="text" placeholder="e.g I will do something I realy good at" />
            ...
            <textarea name="" id="" cols="30" rows="16" placeholder="Breif description to introduce your self to customers"></textarea>
